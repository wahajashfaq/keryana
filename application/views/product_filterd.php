      ...
      <div class="col-md-3 product  col-xs-6 col-sm-6" style="padding-left:0px;padding-right:0px">
                                              ...
                                              if(count($row["Units"])==1){
                                               ...
                                               <span class="rs_tag" id="<?php echo $row["EncryptedId"]; ?>" >Rs </span>
                                                   ...
                                                   <span style="color:#A1DB09 !important">Rs</span><span style="color:#6B953E !important;font-weight:bold" class="nprice new_arrivals_nprice" id="<?php echo $row["EncryptedId"]; ?>" > <?php echo round($row["Units"][0]["Price"]-$row["Units"][0]["Discount"]) ?></span><br><br>
        ...
        <?php $countx++;if($countx==4){ $countx=0;?>
        </div><div class="row">
        <?php
      } // End of Foreach Loop ?>
      <?php }
