	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
								...
								<table class="table table-hover" id="all_table">
									...
									<tbody>
										...
										<tr>
											...
											<td><i  name="<?php echo $count; ?>" onclick="add_sellings(this)" type="radio" id="<?php echo $row['ID'] ?>" title="Add to New Arrivals" class="fa fa-toggle-right fa-fw"></i></td>
										</tr>
									<?php endforeach ?>
			...
			<div class="col-sm-1">
				...
				<br><br>
				<br><br>
				<a href="<?php echo base_url('admin/NewArrivals/autoAdd') ?>"><img  width="80px" height="80px" src="<?php echo base_url('assets/images/add.gif') ?>"></a>
			</div>
			<div class="col-lg-5">
				<div class="panel panel-success">
					<div class="panel-heading"><center>New Arrivals</center></div>
					<div class="panel-body" style="height: 90vh;overflow-y: scroll;">
							...
							<table class="table table-hover" id="all_table_two">
								...
								<tbody>
									...
									<tr>
										<td><img widtd="50" height="50" src="<?php echo base_url("uploads/product_images/".$row['Image']) ?>"></td>
										<td><?php echo $row['Name'] ?></td>
										<td><i  name="<?php echo $count; ?>" onclick="remove_sellings(this)" type="radio" id="<?php echo $row['ID'] ?>" title="Remove From New Arrivals" class="fa fa-remove fa-fw"></i></td>
									</tr>
								<?php endforeach ?>
...
<script type="text/javascript">
	...
	function add_sellings(e){
            ...
            jQuery.ajax({
            	...
            	type: "POST",
            	url: "<?php echo base_url(); ?>" + "/admin/NewArrivals/add",
            	dataType: 'text',
            	data: {
            		productID : e.id
            	},
...
function remove_sellings(e){
	...
	jQuery.ajax({
            	...
            	type: "POST",
            	url: "<?php echo base_url(); ?>" + "/admin/NewArrivals/remove",
            	dataType: 'text',
            	data: {
            		productID : e.id
            	},
