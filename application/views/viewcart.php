  ...
  <div class="row">
    ...
    <div class="col-md-3" style="overflow-x: visible;">
            <!-- div class="div-welc1">
                  ...
                  <table class="table table-bordered" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <center><div class="qmang" style="display:block;margin-top:10px"><i class="fa fa-minus" onclick="minus(this)" aria-hidden="true"></i><span class="qval" data-price="<?php echo $row["Price"] ?>" id="<?php echo $row["ProductID"] ?>"><?php echo $row["Quantity"];?></span><i onclick="plus(this)" class="fa fa-plus" aria-hidden="true"></i></div></center>
                        </td>
                        <td><center>Rs <?php echo $row["Price"]; ?></center></td>
                        <td><center>Rs <?php echo $discount; ?></center></td>
                        <td><center>Rs <?php echo ($row["Price"]*$row["Quantity"])-$discount; ?></center></td>
                        <td><center><i  id="<?php echo $row["ProductID"] ?>" onclick="removeProduct(this);" class="fa fa-trash-o" aria-hidden="true" style="font-size:20px;color:#28a7db"></i></center></td>
                      </tr>
              ...
              <a href="<?php echo base_url('customer/checkout') ?>" class="pull-right">Checkout</a>
            </div>
