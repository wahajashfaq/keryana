    ...
    <div class="row">
        <div class="col-md-12">
            <div class="catebox">
                ...
                <center><h2>Welcome to Keryana.com</h2></center>
                <center><div class="odiv">Please check you email for confirmation</span></div></center>
                <center><div class="odiv1">Happy Buying :)</div></center><br><br>
                <center><button class="confirmbtn"  href="">Home</button></center>
            </div>   
        </div>
    </div>
